			...
			{editingSubject === subject.id ? (
				...
				<>
					...
					<select
						...
						className="py-3 px-4 block w-20 border-gray-200 rounded-lg font-semibold text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-800 text-neutral-500 dark:text-neutral-400"
					>
